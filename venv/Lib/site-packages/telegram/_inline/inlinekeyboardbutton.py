...
class InlineKeyboardButton(TelegramObject):
    ...
    Note:
        * You must use exactly one of the optional fields. Mind that :attr:`callback_game` is not
          ...
          work.
        * If your bot allows for arbitrary callback data, in buttons returned in a response
        ...
        * Since Bot API 5.5, it's now allowed to mention users by their ID in inline buttons.
